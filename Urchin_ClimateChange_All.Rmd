...
#GrowthFigs<-plot_grid(GrowthTemp, GrowthpH, labels = c("a", "b"), ncol=2, nrow=1, rel_heights= c(1,1), rel_widths = c(1,1), label_size = 20, label_y=1, align="h");GrowthFigs

#ggsave(filename="Figures/20200611/GrowthFigs.png", plot=GrowthFigs, dpi=300, width=16, height=6, units="in")
