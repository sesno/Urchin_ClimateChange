...
```{r Relative Spine Lengths, echo = FALSE}
...
setwd("/Users/emilysesno/Desktop/Emily/Graduate Work/Urchin_ClimateChange/Data")
structure <- read.csv("Urchin_ClimateChange_Structure.csv", header=T, na="NA")
